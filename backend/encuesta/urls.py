...
urlpatterns = [
	...
	url('api/encuesta=(?P<pk>\d+)/update$', views.EncuestaDetailView.as_view(), name='encuesta-list' ),
	...
	url('api/pregunta_detalle=(?P<pk>\d+)/detail/$', views.Pregunta_detalleDetailView.as_view() , name='pregunta_detalle-detail'),
